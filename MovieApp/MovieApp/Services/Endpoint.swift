...
enum Endpoint {
    case trending, topRated, genre, nowplaying, movieReview(_ id: Int), discoverMovies, watchTrailer(_ id: Int), movieCredits(_ id: Int), similarMovies(_ id: Int), searchMovie
